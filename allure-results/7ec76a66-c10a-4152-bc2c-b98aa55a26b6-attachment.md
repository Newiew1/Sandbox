...
- Name: home.spec.ts >> Home Page Tests >> TC020: Verify How It Works section is visible
- Location: tests\home.spec.ts:108:7
...
Call log:
  ...
  - waiting for locator('section').nth(1)
