...
- Name: explore.spec.ts >> Explore Page Tests >> TC034: Navigation is visible on explore page
- Location: tests\explore.spec.ts:69:7
...
```ts
  ...
  34 |     await expect(explorePage.page.locator('[data-section="trending"]')).toBeVisible();
  35 |   });
  36 | 
  ...
  62 |     await expect(explorePage.page.locator('[data-role="cta-button"]').first()).toBeVisible();
  63 |   });
  64 | 
...
> 70 |     await expect(explorePage.page.locator('nav')).toBeVisible();
     |                                                   ^ Error: expect(locator).toBeVisible() failed
  71 |   });
  72 | 
  73 |   test('TC035: Footer is visible on explore page', async () => {
  74 |     await expect(explorePage.page.locator('footer')).toBeVisible();
  75 |   });
  76 | });
  77 | 
```