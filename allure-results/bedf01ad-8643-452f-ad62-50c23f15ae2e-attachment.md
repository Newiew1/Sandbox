...
- Name: concepts.spec.ts >> Concepts Page Tests >> TC069: Important notes are displayed
- Location: tests\concepts.spec.ts:99:7
...
Locator: locator('[data-role="important-notes"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-role="important-notes"]')
