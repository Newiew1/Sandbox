...
- Name: concepts.spec.ts >> Concepts Page Tests >> TC067: Overview section is visible
- Location: tests\concepts.spec.ts:89:7
...
Locator: locator('[data-section="overview"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-section="overview"]')
