...
- Name: blogs.spec.ts >> Blogs Page Tests >> TC105: Navigation is visible on blogs page
- Location: tests\blogs.spec.ts:82:7
...
```ts
  ...
  64  |     const blogCards = blogsPage.page.locator('[data-role="blog-card"]');
...
> 83  |     await expect(blogsPage.page.locator('nav')).toBeVisible();
      |                                                 ^ Error: expect(locator).toBeVisible() failed
  84  |   });
  85  | 
  86  |   test('TC106: Footer is visible on blogs page', async () => {
  87  |     await expect(blogsPage.page.locator('footer')).toBeVisible();
  88  |   });
  89  | 
