...
Call log:
  ...
  - waiting for locator('h2, h3').nth(1)
    13 × locator resolved to <h3 class="MuiTypography-root MuiTypography-h6 text-lg font-semibold text-gray-900 mb-4 css-1imvwru"></h3>
